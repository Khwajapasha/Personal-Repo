      ...
      <div>
        <header className="main-header">
          <div className=" d-flex justify-content-center align-item-center flex-column py-5 ">
            <h1 className="main-heading "> PICKUP BIZZ</h1>
                    ...
                    <div className="col-12 card p-4 shadow blog-left--div">
                      ...
                      <figure className="right-side-img mb-5">
                        <img
                          ...
                          src="https://pyxis.nymag.com/v1/imgs/0d6/694/20f338c5aa5a2a4e12be4e5da632ec53b2-silicon-valley-mac.rsquare.w700.jpg"
                          alt=" "
                        />
                      </figure>
                      <p>
